...
CREATE TABLE PARTICIPANT
   (
    ...
    PART_POIDS NUMBER(3)  NOT NULL,
    PART_TAILLE NUMBER(3)  NOT NULL,
...
CREATE TABLE ETAPE
   (
    ...
    ETAPE_NOM VARCHAR2(10)  NOT NULL,
    ETAPE_DATE DATE  NOT NULL,
    ETAPE_DISTANCE NUMBER(3)  NOT NULL,
    TETAPE_LIB VARCHAR2(30)  NOT NULL,
    VILLE_NOM_DEBUTER VARCHAR2(50)  NOT NULL,
    VILLE_NOM_FINIR VARCHAR2(50)  NOT NULL,
    VILLE_NUM_FINIR NUMBER(5)  NOT NULL,
    VILLE_NUM_DEBUTER NUMBER(5)  NOT NULL 
   ) 
   TABLESPACE BD50_DATA 
   ;
-- -----------------------------------------------------------------------------
