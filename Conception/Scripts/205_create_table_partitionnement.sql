...
CREATE TABLE POINT_PASSAGE
   (
    ...
    PT_PASS_NOM VARCHAR2(25)  NOT NULL,
    PT_PASS_VILLE_NOM VARCHAR2(50)  NOT NULL,
    PT_PASS_KM_DEP NUMBER(3)  NOT NULL,
    PT_PASS_KM_ARR NUMBER(3)  NOT NULL,
    PT_PASS_ALT NUMBER(4)  NOT NULL,
    PT_PASS_HORAIRE VARCHAR2(5)  NOT NULL,
...
CREATE TABLE PASSER
   (
    ...
    PT_PASS_NUM NUMBER(3)  NOT NULL,
    PART_NUM NUMBER(3)  NOT NULL,
    PASS_CLASS NUMBER(3)  NOT NULL,
    PASS_TPS NUMBER(10)  NOT NULL
